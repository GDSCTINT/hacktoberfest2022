...
Este projeto visa simplificar e orientar a forma como os iniciantes fazem sua primeira contribuição. Se você deseja fazer sua primeira contribuição, siga as etapas abaixo.

_Se você não estiver confortável com a linha de comando, [aqui estão tutoriais usando ferramentas GUI.](#tutorials-using-other-tools)_

<img align="right" width="300" src="https://firstcontributions.github.io/assets/Readme/fork.png" alt="fork this repository" />

#### Se você não tem git em sua máquina, [Instalar](https://help.github.com/articles/set-up-git/)

## Bifurcar este repositório

Birfuque este repositório clicando no botão fork no topo desta página.
...
Agora clone o repositório bifurcado para sua máquina. Vá para sua conta do GitHub, abra o repositório bifurcado, clique no botão de código e clique no ícone _copiar para a área de transferência_.
...
onde "url que você acabou de copiar" (sem as aspas) é o URL para este repositório (seu fork deste projeto). Consulte as etapas anteriores para obter o URL.
...
```
git clone https://github.com/Você/first-contributions.git
```

onde `este é você` é seu nome de usuário do GitHub. Aqui você está copiando o conteúdo do repositório de primeiras contribuições no GitHub para o seu computador.
...
## Faça as alterações necessárias e confirme essas alterações

Agora abra o arquivo `Contributors.md` em um editor de texto, adicione seu nome a ele. Não o adicione no início ou no final do arquivo. Coloque-o em qualquer lugar no meio. Agora, salve o arquivo.

<img align="right" width="450" src="https://firstcontributions.github.io/assets/Readme/git-status.png" alt="git status" />

Se você for ao diretório do projeto e executar o comando `git status`, verá que há mudanças.

Adicione essas alterações ao branch que você acabou de criar usando o comando `git add`:
...
```
git commit -m "Adicione seu nome a lista Contributors"
```
...
```
git push origin -u nome_da_sua_branch
```

substituindo `nome_da_sua_branch` pelo nome do branch que você criou anteriormente.


<details>
<summary> <strong>Se você receber algum erro ao fazer o push, clique aqui:</strong> </summary>
...
- ### Erro de autenticação
  ...
  acesse: [GitHub's tutorial](https://docs.github.com/en/authentication/connecting-to-github-with-ssh/adding-a-new-ssh-key-to-your-github-account) 
  sobre como gerar e configurar uma chave SSH para sua conta.
...
Agora envie a solicitação pull.
...
Parabéns! Você acabou de concluir o fluxo de trabalho padrão _fork -> clone -> edit -> pull request_ que você encontrará frequentemente como colaborador!

Comemore sua contribuição e compartilhe com seus amigos e seguidores acessando [web app](https://firstcontributions.github.io/#social-share).

Você pode se juntar à nossa equipe do slack se precisar de ajuda ou tiver alguma dúvida.[Entrar no time slack](https://join.slack.com/t/firstcontributors/shared_invite/zt-1hg51qkgm-Xc7HxhsiPYNN3ofX2_I8FA).

Agora vamos começar a contribuir para outros projetos. Compilamos uma lista de projetos com problemas fáceis que você pode começar. Confira [a lista de projetos no aplicativo da web](https://firstcontributions.github.io/#project-list).
